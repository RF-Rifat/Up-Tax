                  ...
                  <div className="flex gap-x-6">
                    <div className="flex">
                      <input
                        ...
                        value="কাঁচা"
                        defaultChecked={
                          infrastructure === "কাঁচা" && infrastructure
                        }
                    ...
                    <div className="flex">
                      <input
                        ...
                        value="পাকা"
                        defaultChecked={
                          infrastructure === "পাকা" && infrastructure
                        }
                        className="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                        id="hs-radio-group-2"
                      />
                    ...
                    <div className="flex">
                      <input
                        ...
                        value="আধা পাকা"
                        defaultChecked={
                          infrastructure === "আধা পাকা" && infrastructure
                        }
                        className="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                        id="hs-radio-group-2"
                      />
